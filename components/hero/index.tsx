...
const Hero = () => {
  ...
  //             TURCVG Will <span className="text-light_purple">Help You</span> To
  //             Find!
  //           </h1>
  //           <p className="mb-8 text-2xl leading-normal">
  //             Easiest way to buy home. Just choose your dream house and connect
  //             us.
  //           </p>
  //           <Link href='/residence' className="px-8 py-4 mx-auto my-6 font-bold text-white transition duration-300 ease-in-out transform rounded-full shadow-lg hover:bg-purple bg-light_purple lg:mx-0 hover:underline focus:outline-none focus:shadow-outline hover:scale-105">
  //             See Residence
  //           </Link>
  //         </div>
  //         <div className="flex justify-end w-full py-6 text-center md:w-3/5">
  //           <Image
  //             width={600}
  //             height={400}
  //             alt="residence"
  //             className="z-50 w-full rounded md:h-[400px] md:w-4/5"
  ...
  return (
    <div className="text-white h-screen bg-[url('/images/background.jpg')] bg-no-repeat bg-cover">
      <div className="flex flex-col flex-wrap items-center justify-center h-full px-4 mx-auto gap-y-12 max-w-7xl sm:px-6 lg:px-8 ">
        <h1 className="text-[100px] font-bold tracking-wider text-center">
          TURCVG
        </h1>
